...
function dibujar_plano(pCanvas = "micanvas"){
var pl = document.getElementById("P30_PLARGO").value;
var pa = document.getElementById("P30_PANCHO").value;
...
// Fill with gradient
ctx.fillStyle = grd;
ctx.strokeRect(0,0,pl,pa);
}



function dibujar_plano2(pCanvas = "micanvas"){
	var tipo = document.getElementById("P62_TIPO").value;
		
	if (tipo != 2 && document.getElementById('P62_CORTANTE_ID').value == ""){
		var c = document.getElementById(pCanvas);

		var mult = document.getElementById("P62_MULT_R").value;
		mult = mult.replace(',','.')*1;
		var largo = document.getElementById("P62_LARGO").value*1;
		var ancho = document.getElementById("P62_ANCHO").value*1;
		var alto = document.getElementById("P62_ALTO").value*1;
		var mult_x = document.getElementById("P62_MULT_X").value;
		var mult_y = document.getElementById("P62_MULT_Y").value;
		gZoom = document.getElementById("P62_ZOOM").value*1;
		...
		gRefile = $('#P62_REFILE')[0].value * 1;

		if (document.getElementById("P62_DESARROLLO")){
			cierre = document.getElementById("P62_CIERRE").value*1;
			cierre_val = document.getElementById("P62_CIERRE_VAL").value*1;
			desarrollo = document.getElementById("P62_DESARROLLO").value*1;
		}
		if (document.getElementById("P62_ALETA_ARRIBA")){
			aleta_arriba = document.getElementById("P62_ALETA_ARRIBA").value*1;
			aleta_arriba_val = Math.round(document.getElementById("P62_ALETA_ARRIBA_VAL").value*1);
		}
		if (document.getElementById("P62_ALETA_ABAJO")){
			aleta_abajo = document.getElementById("P62_ALETA_ABAJO").value*1;
			aleta_abajo_val = Math.round(document.getElementById("P62_ALETA_ABAJO_VAL").value*1);
		}
		var centro = 0;
		
		if (document.getElementById("P62_GUIA"))
			centro = document.getElementById("P62_GUIA").value*1;
		...
		case "7":
			...
			if (aleta_arriba == 1){
				document.getElementById("P62_ALETA_ARRIBA_VAL").value = Math.round(ancho/2);
				aleta_arriba_val = ancho/2;
			}
			if (aleta_abajo == 1){
				document.getElementById("P62_ALETA_ABAJO_VAL").value = Math.round(ancho/2);
	...
	} else if (tipo == 2 && document.getElementById('P62_CORTANTE_ID').value != ""){
		...
		if (document.getElementById("P62_P_LARGO").value != undefined){
			continuar = true;
			var largo = document.getElementById("P62_P_LARGO").value;
		}
		if (document.getElementById("P62_P_ANCHO").value != undefined){
			continuar = true;
			var ancho = document.getElementById("P62_P_ANCHO").value;
		}
...
function art_0_1_9(c,l,a,izq,mult,aleta_arriba,aleta_arriba_val,aleta_abajo,aleta_abajo_val,trazados,pCanvas = "micanvas"){
	...
	if (trazados.length > 0){
		...
		if (document.getElementById("P62_TIPO").value != 9)
	...
	if (mult > 1){
		...
		if ($('#P62_STATUS')[0].value == 1){
			if (document.getElementById("P62_TIPO").value != 2)
				document.getElementById("P62_P_LARGO").value = Math.round(l*mult)+gRefile;
		}
	}
	...
	if (document.getElementById("P62_TIPO").value != 2){
		document.getElementById("P62_P_LARGO").value = Math.round(l*mult)+gRefile;
		document.getElementById("P62_P_ANCHO").value = Math.round(a);
	}
	//trazados.push(a);
...
function art_3(c,l,a,alt,mult_x,mult_y,pCanvas = "micanvas"){
	...
	if ($('#P62_STATUS')[0].value == 1){
		document.getElementById("P62_P_ANCHO").value = Math.round(alt);
		document.getElementById("P62_P_LARGO").value = Math.round(l*mult_x + a * mult_y)+gRefile;

		document.getElementById("P62_TRAZADOS").disabled = false;
		document.getElementById("P62_TRAZADOS").value = '|' + alt + '|';
		document.getElementById("P62_TRAZADOS").disabled = true;
	}
}
...
* function art_caja
***********************************************/
function art_caja(c,l,a,alt,cierre,cierre_val,aleta_arriba,aleta_arriba_val,aleta_abajo,aleta_abajo_val,desarrollo,trazados,pCentro,pCanvas = "micanvas"){
	...
	if ($('#P62_STATUS')[0].value == 1){
		document.getElementById("P62_P_ANCHO").value = Math.round(itemAltoTotal);
		document.getElementById("P62_P_LARGO").value = Math.round(itemLargoTotal)+gRefile;
	}
	//TRAZADOS
	var traz = 0;
	gTrazado = new Array();
...
function art_8(c,l,a,alt,aleta_arriba,aleta_arriba_val,aleta_abajo,aleta_abajo_val,mult_x,trazados,pCentro,pCanvas = "micanvas"){
	...
	if ($('#P62_STATUS')[0].value == 1){
		document.getElementById("P62_P_ANCHO").value = Math.round(finalAltoTotal);
		document.getElementById("P62_P_LARGO").value = Math.round(finalLargoTotal)+gRefile;
	}
...
function medidasTrazados (ctx,x,y,trazados,altoTotal,largoTotal,divisor){
	...
	if ($('#P62_STATUS')[0].value == 1){
		document.getElementById("P62_TRAZADOS").disabled = false;
		document.getElementById("P62_TRAZADOS").value = trazados.reverse().join("|");
		document.getElementById("P62_TRAZADOS").disabled = true;
	}
}

function medidasTrazados2 (ctx,x,y,trazados,altoTotal,largoTotal,divisor,pCanvas = "micanvas"){
	...
	if ($('#P62_STATUS')[0].value == 1 && document.getElementById("P62_TIPO").value != 2){
		document.getElementById("P62_TRAZADOS").disabled = false;
		document.getElementById("P62_TRAZADOS").value = "|" + trazados.reverse().join("|") + "|";
		document.getElementById("P62_TRAZADOS").disabled = true;
	}
...
function writeCanvas (ctx,text,x,y,tamano = "12px",pCanvas = "micanvas"){
	ctx.fillStyle = "blue";
	if (pCanvas == "micanvas")
