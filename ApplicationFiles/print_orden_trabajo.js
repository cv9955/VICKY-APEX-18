...
function refresh_canvas(pCanvas = "micanvas"){
	var tipo = document.getElementById("P_TIPO").value;
		
	if (tipo != 2 && document.getElementById('P_CORTANTE_ID').value == ""){
		var c = document.getElementById(pCanvas);

		var mult = document.getElementById("P_MULT_R").value;
		mult = mult.replace(',','.')*1;
		var largo = document.getElementById("P_LARGO").value*1;
		var ancho = document.getElementById("P_ANCHO").value*1;
		var alto = document.getElementById("P_ALTO").value*1;
		var mult_x = document.getElementById("P_MULT_X").value;
		var mult_y = document.getElementById("P_MULT_Y").value;
		gZoom = document.getElementById("P_ZOOM").value*1;
		...
		gRefile = $('#P_REFILE')[0].value * 1;

		if (document.getElementById("P_DESARROLLO")){
			cierre = document.getElementById("P_CIERRE").value*1;
			cierre_val = document.getElementById("P_CIERRE_VAL").value*1;
			desarrollo = document.getElementById("P_DESARROLLO").value*1;
		}
		if (document.getElementById("P_ALETA_ARRIBA")){
			aleta_arriba = document.getElementById("P_ALETA_ARRIBA").value*1;
			aleta_arriba_val = Math.round(document.getElementById("P_ALETA_ARRIBA_VAL").value*1);
		}
		if (document.getElementById("P_ALETA_ABAJO")){
			aleta_abajo = document.getElementById("P_ALETA_ABAJO").value*1;
			aleta_abajo_val = Math.round(document.getElementById("P_ALETA_ABAJO_VAL").value*1);
		}
		var centro = document.getElementById("P_GUIA").value*1;
		...
		case "7":
			...
			if (aleta_arriba == 1){
				//document.getElementById("P_ALETA_ARRIBA_VAL").value = Math.round(ancho/2);
				aleta_arriba_val = ancho/2;
			}
			if (aleta_abajo == 1){
				//document.getElementById("P_ALETA_ABAJO_VAL").value = Math.round(ancho/2);
	...
	} else if (tipo == 2 && document.getElementById('P_CORTANTE_ID').value != ""){
		...
		if (document.getElementById("P_P_LARGO").value != undefined){
			continuar = true;
			var largo = document.getElementById("P_P_LARGO").value;
		}
		if (document.getElementById("P_P_ANCHO").value != undefined){
			continuar = true;
			var ancho = document.getElementById("P_P_ANCHO").value;
		}
...
function art_0_1_9(c,l,a,izq,mult,aleta_arriba,aleta_arriba_val,aleta_abajo,aleta_abajo_val,trazados,pCanvas = "micanvas"){
	...
	if (trazados.length > 0){
		...
		if (document.getElementById("P_TIPO").value != 9)
	...
	if (mult > 1){
		...
		//if (document.getElementById("P_TIPO").value != 2)
		//	document.getElementById("P_P_LARGO").value = Math.round(l*mult)+gRefile;
	}
	...
	//if (document.getElementById("P_TIPO").value != 2){
	//	document.getElementById("P_P_LARGO").value = Math.round(l*mult)+gRefile;
	//	document.getElementById("P_P_ANCHO").value = Math.round(a);
	//}
	//trazados.push(a);
...
function art_3(c,l,a,alt,mult_x,mult_y,pCanvas = "micanvas"){
	...
	//document.getElementById("P_P_ANCHO").value = Math.round(alt);
	//document.getElementById("P_P_LARGO").value = Math.round(l*mult_x + a * mult_y)+gRefile;

	//if ($('#P_STATUS')[0].value == 1){
	//	document.getElementById("P_TRAZADOS").disabled = false;
	//	document.getElementById("P_TRAZADOS").value = '|' + alt + '|';
	//	document.getElementById("P_TRAZADOS").disabled = true;
	//}
}
...
function art_caja(c,l,a,alt,cierre,cierre_val,aleta_arriba,aleta_arriba_val,aleta_abajo,aleta_abajo_val,desarrollo,trazados,pCentro,pCanvas = "micanvas"){
	...
	if (gRefile > 0){
  	...
  	//document.getElementById("P_P_ANCHO").value = Math.round(itemAltoTotal);
	//document.getElementById("P_P_LARGO").value = Math.round(itemLargoTotal)+gRefile;
...
function art_8(c,l,a,alt,aleta_arriba,aleta_arriba_val,aleta_abajo,aleta_abajo_val,mult_x,trazados,pCentro,pCanvas = "micanvas"){
	...
	//document.getElementById("P_P_ANCHO").value = Math.round(finalAltoTotal);
	//document.getElementById("P_P_LARGO").value = Math.round(finalLargoTotal)+gRefile;
...
function medidasTrazados (ctx,x,y,trazados,altoTotal,largoTotal,divisor){
	...
	//if ($('#P_STATUS')[0].value == 1){
	//	document.getElementById("P_TRAZADOS").disabled = false;
	//	document.getElementById("P_TRAZADOS").value = trazados.reverse().join("|");
	//	document.getElementById("P_TRAZADOS").disabled = true;
	//}
}
...
function medidasTrazados2 (ctx,x,y,trazados,altoTotal,largoTotal,divisor,pCanvas = "micanvas"){
	...
	//if ($('#P_STATUS')[0].value == 1 && document.getElementById("P_TIPO").value != 2){
	//	document.getElementById("P_TRAZADOS").disabled = false;
	//	document.getElementById("P_TRAZADOS").value = "|" + trazados.reverse().join("|") + "|";
	//	document.getElementById("P_TRAZADOS").disabled = true;
	//}
